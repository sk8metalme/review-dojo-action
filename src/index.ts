...
import { FileSystemKnowledgeRepository } from './infrastructure/FileSystemKnowledgeRepository.js';
import { MarkdownSerializer } from './infrastructure/MarkdownSerializer.js';
...
/**
 * CLI Entry Point for review-dojo-action
 * Applies knowledge from JSON file to markdown files
 */
